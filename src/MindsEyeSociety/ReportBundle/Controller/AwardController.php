...
namespace MindsEyeSociety\ReportBundle\Controller;

use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Method;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Route;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Template;
use MindsEyeSociety\ReportBundle\Entity\Award;
use MindsEyeSociety\ReportBundle\Form\AwardType;
...
class AwardController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MindsEyeSocietyReportBundle:Award')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MindsEyeSocietyReportBundle:Award')->find($id);
    ...
    {
        $entity = new Award();
        $entity->setEarned(new \DateTime(date('Y-m')));
        $entity->setAwarded(new \DateTime(date('Y-m')));
     ...
     * @Method("post")
     * @Template("MindsEyeSocietyReportBundle:Award:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("MindsEyeSocietyReportBundle:Award:edit.html.twig")
     */
